...
I actually didn't have trouble passing any of the tests...I got them all on the first try although I'm not sure my strategy was the shortest way to write this out.

How difficult was it to add and delete properties outside of the object itself?

Surprisingly easy, it was actually kind of refreshing to be able to make so many modifications just by calling new properties or objects with the dot.

What did you learn about manipulating objects in this challenge?

I learned how to create an empty object, which was pretty intuitive, how to delete properties and how to create circular properties/objects that refer back to one another.
